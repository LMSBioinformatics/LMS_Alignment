...
# Building index
refFasta <- list.files(path="Data",pattern="chr2.fa$", full=T)
tmp <- bowtie_build(references=refFasta, outdir="Data", prefix="mm9index_chr2", force=TRUE)

# Aligning sequences
bowtie(sequences="Data/ENCFF001LGM_chr2.fastq",
       index=file.path("Data", "mm9index_chr2"), 
       outfile="Data/CTCF_mm9_MF_chr2.sam",
       sam=TRUE, 
       best=TRUE, 
       force=TRUE,
       threads=4,
...
insam <- "Data/CTCF_mm9_MF_chr2.sam"
outbam <- "Data/CTCF_mm9_MF_chr2"
